...
Shao ZHANG received her doctoral degree from Shanghai Jiao Tong University in 2025, under the supervision of [Prof. Ying WEN](https://yingwen.io/) and [Prof. Xinbing WANG](https://www.cs.sjtu.edu.cn/~wang-xb/). 
...
Shao's research interests include **Human-AI Collaboration** and **Multi-agent Systems**. 
...
- **Language Agent** in real-time simultaneous human-AI collaboration,
- **(Multi-)Agent System** as data flywheel to collect real world human feedback for large language models training and evaluation.
